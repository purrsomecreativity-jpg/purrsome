...
interface SpotlightCardProps {
  ...
  className?: string;
  style?: CSSProperties;
  glowColor?: keyof typeof HUE_MAP;
  backupBorder?: string;
  backdrop?: string;
}
...
export function SpotlightCard({
  ...
  style,
  glowColor = "blue",
  backupBorder = "rgba(255,255,255,0.07)",
  backdrop = "rgba(255,255,255,0.01)",
}: SpotlightCardProps) {
  const ref = useRef<HTMLDivElement>(null);
  const { base, spread } = HUE_MAP[glowColor];
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: `radial-gradient(
            ...
            calc(var(--x, 0) * 1px) calc(var(--y, 0) * 1px),
            hsl(var(--hue, 210) 100% 70% / 0.04), transparent
          )`,
          backgroundColor: backdrop,
          backgroundAttachment: "fixed",
          border: `1px solid ${backupBorder}`,
          ...style,
        } as CSSProperties}
      >
        <div data-glow />
