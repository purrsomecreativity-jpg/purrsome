...
const defaultData = {
  ...
  resume: { label: "Resume" } as { label: string; onClick?: () => void },
  hero: {
  ...
  ctaButtons: {
    primary: { label: "View My Work" } as { label: string; onClick?: () => void },
    secondary: { label: "Get In Touch" } as { label: string; onClick?: () => void },
  },
  projects: [
    {
  ...
  return (
    <div className="bg-primary text-white">
      ...
      <div className="relative">
        ...
        <div className="starfall-divider" />
        <main
          id="about"
        ...
        >
          <div className="max-w-6xl mx-auto text-center">
            <div className="mb-8 float-animation">
              <h1 className="md:text-6xl lg:text-7xl leading-[1.1] text-5xl font-light text-white tracking-tight mb-4">
                {hero.titleLine1}
                <span className="starfall-gradient-text block tracking-tight">
                  {hero.titleLine2Gradient}
                </span>
              </h1>
              <p className="md:text-xl max-w-3xl leading-relaxed text-lg font-light text-muted mx-auto">
                {hero.subtitle}
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <button
                ...
                className="starfall-primary-button px-6 py-3 text-white rounded-lg font-medium text-sm min-w-[160px]"
              >
            ...
            <div className="starfall-divider mb-16" />
            <div
              id="projects"
            ...
            >
              {projects.map((project, index) => (
                ...
                >
                  <div className="starfall-project-image rounded-xl h-32 mb-4 flex items-center justify-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="starfall-skill-badge px-2 py-1 rounded text-xs text-muted"
                      >
                        {tag}
                      </span>
                    ))}
